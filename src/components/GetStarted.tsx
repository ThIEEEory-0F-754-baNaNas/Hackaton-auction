  ...
  return (
    <div className="flex flex-col 2xl:items-start items-center justify-center gap-y-8">
      ...
      <Typography color="blue-gray" variant="h5" className="max-w-96">
        ...
        Participate in auctions, pick up goods, and part of the funds spent will
        be directed to charitable needs!
      </Typography>
      <Button className="mt-6" variant="gradient" onClick={onButtonClick}>
        Get Started
      </Button>
    </div>
  );
